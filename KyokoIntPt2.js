document.addEventListener("DOMContentLoaded", function(event) {
    ...
    var sprite =   document.getElementsByClassName('sprite-placement')
    console.log(sprite);
...
var answer = [
  ...
  "<img src = 'cryingKiyoko.gif' alt ='Kiyoko crying' height='160' width='400'><br><br>Please... Please... Please I didn't kill him. I didn't kill him. I didn't kill him. I didn't kill him.I swear. I admit it- I was scared of him. I was scared that he'd take my son away if I left, but I'd never murder him. Even if I didn't go to jail, his parents would find away to take my son away."
]
...
function scenerioChecker(){
  ...
  if (this.innerHTML == question[0]){
    ...
    document.body.style.backgroundImage = "url('Kiyoko fight.jpg')"
    title.innerHTML = "Kiyoko's Memory"
    sprite[0].style.visibility = "hidden"
...
option4.style.visibility = "visible"
option3.innerHTML = question[3]
document.body.style.backgroundImage = "url('interrogation.png')"
}
}
